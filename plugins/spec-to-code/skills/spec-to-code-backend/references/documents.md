...
**Language:** write every document and its prose in **Korean (한글)**; keep code, identifiers, file paths, cell names, API/route/field names, and SQL in English. (The templates below use English headings for reference — fill the content in Korean.)
