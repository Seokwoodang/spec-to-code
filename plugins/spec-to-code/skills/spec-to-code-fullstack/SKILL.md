...
## Rules
- **Thin by design** — this skill has *no verification of its own*. All testing/review/docs happen inside the two specialist runs. Its only owned artifact is `api-contract.md`.
