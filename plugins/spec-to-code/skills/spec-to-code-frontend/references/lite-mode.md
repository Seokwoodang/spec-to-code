...
- **the filled grid** (reduced `00-behavior-grid.md`) — enumeration is unconditional; only the fan-out/critic are dropped;
...
| | full | lite |
|---|---|---|
| gap analysis | exhaustive `gap-hunter` fan-out + critic | inline quick scan + **reduced grid** (`00-behavior-grid.md`); fan-out/critic dropped |
